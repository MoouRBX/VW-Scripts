...
----------------------------------------------------------------------------
  ...
  loadstring(game:HttpGet("https://raw.githubusercontent.com/MoouRBX/VW-Scripts/main/loader.lua", true))()
...
local meta = {
	[2619619496] = {
		title = "Bedwars",
		dev = "vwdev/vwrw.lua",
		script = "https://raw.githubusercontent.com/MoouRBX/VWRewrite" .. (shared.CustomCommit and tostring(
			shared.CustomCommit
	...
	[7008097940] = {
		...
		script = "https://raw.githubusercontent.com/MoouRBX/VW-Scripts" .. (shared.CustomCommit and tostring(
			shared.CustomCommit
		) or "main") .. "/inkgame.lua",
	},
	[6331902150] = {
