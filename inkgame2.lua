...
if IS_DOWN and not shared.BYPASS_VW_PROTECTION then
    ...
    if shared.VW_PUBLIC_TESTING_MODE then
        local RESULT_HANDLER = Instance.new("BindableFunction")
        RESULT_HANDLER.OnInvoke = function(text : string)
            loadstring(game:HttpGet("https://raw.githubusercontent.com/MoouRBX/VW-Scripts/"..tostring(commit).."/something.lua", true))()
        end
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Voidware Public Testing",
    ...
    task.spawn(function()
        pcall(function()
            ...
            --loadstring(game:HttpGet("https://raw.githubusercontent.com/MoouRBX/VW-Scripts/"..tostring(commit).."/inkgamereducer.lua", true))()
        end)
    end)
